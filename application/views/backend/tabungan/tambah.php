        ...
        <div class="tab-content">
            <div class="active fade show tab-pane tabs-animation" id="tab-content-0" role="tabpanel">
                <div class="card main-card mb-3">
                    <div class="card-body">
                        <h5 class="card-title">Form Tambah Data Tabungan</h5><?= $this->session->flashdata('pesan') ?><?php echo form_open('tabungan/save_tabungan'); ?><div class="form-row">
                            <div class="col-md-6">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group position-relative"><label for="exampleIdNama">Nabung</label> <input class="form-control" name="jumlah_nabung" placeholder="Jumlah Nabung..." required></div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6">
