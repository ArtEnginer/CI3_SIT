        ...
        <div class="tab-content">
            <div class="active fade show tab-pane tabs-animation" id="tab-content-0" role="tabpanel">
                <div class="card main-card mb-3">
                    <div class="card-body">
                        <h5 class="card-title">Form Tambah Data Pinjaman</h5><?= $this->session->flashdata('pesan') ?><?php echo form_open('pinjaman/save_pinjaman'); ?><div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group position-relative"><label for="exampleIdNama">Waktu Pinjaman</label> <input class="form-control" name="waktu" placeholder="Waktu..." required type="date"></div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group position-relative"><label for="examplenis" class="">Pinjam</label> <input class="form-control" name="jumlah_pinjam" placeholder="Jumlah Pinjam..." required type="number" id="examplenis"></div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6">
